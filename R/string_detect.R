...
get_mt_genes <- function(org, ...) {
  ...
  mt_genes <- get(paste0("biodict_", org)) %>% 
...
#' }
#' @export
get_str_genes <- function(org, str, ...) {
  # Validate organism parameter
  validate_org(org)
