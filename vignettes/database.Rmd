...
mouse.omnipath.db <- mouse.omnipath.db %>%
    ...
    dplyr::select(mouse_gene_symbol, mouse_chromosome, human_gene_symbol, human_chromosome, human_gene_symbol_unique, human_chromosome_unique, entity_type, category, parent, consensus_score, database_cs) %>%
    ungroup()
